...
const grade_level = document.querySelector("#student-grade-level")
const year = document.querySelector("#student-graduation-year")
const profileImag = document.querySelector("#student-image")
const semesterDropDown = document.querySelector(".semester-dropdown")
const semesterDropDownBtn = document.querySelector(".student-name")
...
function updateStudentGradeLevel(studentGradeLevel) {
  grade_level.textContent = studentGradeLevel
}
...
function updateStudentAdvisor(studentAdvisor) {
  advisor.textContent = studentAdvisor
}
...
function updateMajor(studentMajor) {
  major.textContent = studentMajor
}
...
function updateStudentGraduationYear(graduationYear) {
  year.textContent = graduationYear
}
...
function addCourseRowToReportCard(reportCardTableElement, course, rowNum) {
  ...
  <h4 class="sem-col">Sememster</h4>
  <h4 class="cred-col">Credit</h4>
  <h4 class="let-col">Letter</h4>
  <h4 class="points-col">Pointers</h4>
  </div>
  `
}
...
function updateReportCard(reportCardTableElement, currentSemester) {
  ...
  addCourseRowToReportCard(reportCardTableElement, semester, 1)
}
